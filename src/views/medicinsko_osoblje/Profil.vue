...
export default {
  ...
  methods: {
    ...
    odustaniClick() {
      ...
      this.izmeni = false
      axios
      .get("http://localhost:8080/medicinskoOsoblje/postojeceMedicinskoOsoblje")
    ...
    sacuvajPodatke() {
      ...
      axios
      .put("http://localhost:8080/medicinskoOsoblje/izmeniPodatkeMedicinskogOsoblja", this.user)
      .then(medicinskoOsoblje =>{
        this.user = medicinskoOsoblje.data;
        this.izmeni = false;
      })
